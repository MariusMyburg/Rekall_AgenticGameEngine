...
Task 3: fix round 2/5 in progress — retain the Codex runner when unauthenticated model listing fails so Studio sign-in remains available, and require exact approval-method admission instead of substring matching.
