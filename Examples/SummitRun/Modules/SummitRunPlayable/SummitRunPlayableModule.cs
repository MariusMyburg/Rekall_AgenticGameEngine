...
namespace Game.Modules.SummitRunPlayable;

[RekallAgeModule("game.summitrun.playable", "Summit Run Playable")]
[RekallAgeRequiresCapability("world")]
public sealed class SummitRunPlayableModule : RekallAgeModule, IRekallAgePlayableModule
{
