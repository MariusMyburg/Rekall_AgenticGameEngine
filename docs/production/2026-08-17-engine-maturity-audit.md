...
| Animation | Implemented | versioned inline/catalog clips, scalar/vector/color/string tracks, interpolation, loop/clamp/ping-pong, bounded tracks/keys/markers with structured diagnostics, deterministic 7,200-frame resume proof, events, generic property mutation, runtime-state proof | cross-fade/blend layers, skeletal GLB tracks/skinning, state graphs |
