...
| Test platform | Implemented | 533 green tests in two Release passes plus canonical installed acceptance with Vulkan, relocation, SDL audio, and runtime UI visual proof | deprecated xUnit v2 package, broader GPU/headset automation, soak/fuzz/performance regression suites |
