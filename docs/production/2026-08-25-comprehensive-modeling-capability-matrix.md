...
| Armature/skin/weights/constraints | Partial | Wave 3: point-domain joint indices/weights survive edit and Model Asset compilation; a versioned named-joint rig asset now validates hierarchy/bind matrices, evaluates bind/pose/skin matrices, exposes revision-safe commands, and resolves `Rekall.RigPose` through the renderer. Aetherfall proves module-authored named chest motion changes actual rendered vertices | Blender armature modifier and vertex groups; Godot Mesh, Skin, Skeleton, and Skeleton3D resource separation | Add hierarchy/pose Studio editing, automatic/painted multi-joint normalize/prune tools, constraints/IK, retargeting, debug visualization, and complete production-character acceptance |
