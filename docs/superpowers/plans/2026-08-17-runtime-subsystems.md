...
- [ ] Define versioned clips with scalar/vector/color/sprite tracks and interpolation modes.
- [ ] Implement deterministic sampling, loop/clamp/ping-pong time, playback speed, and events.
- [ ] Apply generic component-property and transform tracks without genre assumptions.
