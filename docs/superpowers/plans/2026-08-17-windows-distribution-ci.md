...
- [x] **Step 3: Implement ancestor-only manifest discovery**
...
- [x] **Step 3: Implement safe copy, manifest, and ZIP**
...
- [x] **Step 1: Write the failing installed-payload test**
...
- [x] **Step 3: Implement distribution-first copying**
...
- [x] **Step 1: Add a failing CLI assembly test**
...
- [x] **Step 3: Register and print the assembly command**

Print output root, manifest, archive, file count, and version. Return `1` on command failure.

- [x] **Step 4: Implement installed acceptance**
...
- [x] **Step 5: Implement the canonical build**
...
- [x] **Step 6: Add third-party notices and commit**
...
- [x] **Step 1: Enable dependency locking**
...
- [x] **Step 2: Add authoritative Windows CI**
...
- [x] **Step 3: Document the production build**
...
- [x] **Step 4: Run the complete pipeline**
...
- [x] **Step 5: Inspect and verify output**
...
- [x] **Step 6: Mark complete and commit**
...
- Canonical command: `pwsh ./eng/build.ps1 -Configuration Release -RuntimeIdentifier win-x64`
- Release build: succeeded with 0 warnings and 0 errors.
- Test pass 1: 505 passed, 0 failed, 0 skipped.
- Test pass 2: 505 passed, 0 failed, 0 skipped.
- Distribution manifest: 1,139 files; all SHA-256 digests independently recomputed with 0 mismatches.
- Archive: `Artifacts/Distribution/Rekall-AGE-0.1.0-preview.1-win-x64.zip`, 193,539,961 bytes.
- Package inspection: 0 forbidden files and 0 absolute/source-tree path leaks.
- Installed doctor: Windows host, x64 architecture, product identity, and SDK compatibility ready.
- Installed portable-module proof: scaffolded and built `ProofMotion` using `.rekall/sdk/1` without a source-tree project reference.
- Installed gauntlet: ready; project and scene created, generic blueprint and module authored, package created and audited, proof frame nonblank.
- Experimental capabilities remain explicitly non-blocking and are not promoted by this gate: OpenXR, multiplayer, Tripo3D, and CPU virtual geometry.
