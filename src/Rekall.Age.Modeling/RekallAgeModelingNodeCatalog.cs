...
public sealed class RekallAgeModelingNodeCatalog
{
    ...
    [
        ...
        Node("rekall.modeling.curve.profile_sweep", "Profile Sweep", "Sweeps a closed circle or rectangle profile along deterministic parallel-transport path frames with cap, UV, and material output.",
        ...
        Node("rekall.modeling.weighted_normals", "Weighted Normals", "Authors area-weighted corner normals for stable hard-surface shading.",
            [Input("geometry", RekallAgeModelingValueType.Geometry, required: true), Output("geometry", RekallAgeModelingValueType.Geometry)],
            [Text("attribute", "Attribute", "normal.weighted"), Number("faceAreaWeight", "Face Area Weight", 1, 0, 4)]),
