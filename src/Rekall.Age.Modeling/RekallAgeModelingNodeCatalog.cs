...
public sealed class RekallAgeModelingNodeCatalog
{
    ...
    [
        ...
        Node("rekall.modeling.curve.revolve", "Curve Revolve", "Revolves one evaluated curve profile around an authored axis into deterministic UV/material/provenance-aware mesh topology.",
            [Input("curve", RekallAgeModelingValueType.Curve, required: true), Output("geometry", RekallAgeModelingValueType.Geometry)],
            [Text("axis", "Axis", "y", ["x", "y", "z"]), Vector3("origin", "Origin", "world-unit"), Number("angleDegrees", "Angle", 360, double.Epsilon, 360, "degree"), Integer("segments", "Segments", 32, 3, 4_096), Number("weldDistance", "Weld Distance", 0.000001, 0, 1, "world-unit"), Text("materialAssetId", "Material Asset ID", "material.default"), Text("slotName", "Slot Name", "Revolved Surface")]),
