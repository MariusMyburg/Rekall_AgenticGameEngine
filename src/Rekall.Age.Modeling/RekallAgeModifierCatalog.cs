...
public sealed class RekallAgeModifierCatalog
{
    ...
    public static RekallAgeModifierCatalog CreateDefault()
    {
        ...
        [
            ...
            new("rekall.modifier.deform.taper", 1, "Taper Deform", "Linearly scales point planes perpendicular to an axis across an authored range.",
                RekallAgeMeshChangeKind.Positions,
                [Text("axis", "y"), Number("minimum", 0), Number("maximum", 1), Number("startScale", 1), Number("endScale", 0.5), Number("centerX", 0), Number("centerY", 0), Number("centerZ", 0), Text("selection", "")], preserve),
            new("rekall.modifier.deform.bend", 1, "Bend Deform", "Curves point cross-sections through an authored angle and coordinate range around an origin.",
                RekallAgeMeshChangeKind.Positions,
                [Text("axis", "y"), Text("bendAxis", "z"), Number("minimum", 0), Number("maximum", 1), Number("angleDegrees", 45), Number("centerX", 0), Number("centerY", 0), Number("centerZ", 0), Text("selection", "")], preserve),
