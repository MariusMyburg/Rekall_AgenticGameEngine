    ...
    : IRekallAgeCommand<BootstrapOpenXrSessionRequest, BootstrapOpenXrSessionResult>
{
        ...
        RekallAgeCommandContext context)
    {
        ...
        var result = new BootstrapOpenXrSessionResult(
            ...
            bootstrap.VulkanGraphicsRequirementsReady,
            bootstrap.VulkanGraphicsRequirements,
            bootstrap.PrimaryStereoViewConfigurationReady,
            bootstrap.PrimaryStereoViews,
