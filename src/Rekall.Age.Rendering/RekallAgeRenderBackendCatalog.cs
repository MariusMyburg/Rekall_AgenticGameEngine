        ...
        [
            new RekallAgeRenderBackendDescriptor(
                ...
                [
                    ...
                    "openxr-vulkan-graphics-requirements",
                    "openxr-vulkan-graphics-binding-interop",
                    "openxr-compositor-session-bootstrap",
                    "openxr-swapchain-format-enumeration",
                    "openxr-color-depth-swapchain-allocation",
                    "openxr-vulkan-swapchain-image-enumeration",
                    "openxr-frame-loop-probe",
                    "openxr-swapchain-image-acquire-release",
                    "openxr-zero-layer-frame-submit",
                    "openxr-primary-stereo-view-enumeration",
                    "openxr-external-vkimage-swapchain-wrapping",
