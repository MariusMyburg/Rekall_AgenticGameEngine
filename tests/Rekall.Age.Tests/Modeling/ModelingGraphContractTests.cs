...
public sealed class ModelingGraphContractTests
{
    ...
    public void DefaultNodeCatalogPublishesCanonicalInitialInventory()
    {
        ...
        Assert.Equal(59, catalog.Descriptors.Count);
        ...
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.skin.envelope_weights");
        ...
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.project_uv");
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.shade_faces");
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.mark_sharp");
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.auto_smooth");
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.curve.source");
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.curve.line");
        ...
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.curve.revolve");
        ...
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.bridge_edge_loops");
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.poke_faces");
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.dissolve_edges");
        Assert.Contains(catalog.Descriptors, descriptor => descriptor.TypeId == "rekall.modeling.bisect_plane");
